...
/*@}*/ /* end of group NUC451_SCLIB_EXPORTED_CONSTANTS */

/** @addtogroup NUC451_SCLIB_EXPORTED_STRUCTS Smartcard Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group NUC451_SCLIB_EXPORTED_STRUCTS */

/** @addtogroup NUC451_SCLIB_EXPORTED_FUNCTIONS Smartcard Library Exported Functions
  @{
*/
