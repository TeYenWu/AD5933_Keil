...
# 12 "Library\\StdDriver\\src\\wdt.c"
...
{
    ((WDT_T *) (((0x40000000UL) + 0x00040000) + 0x00000))->ALTCTL = u32ResetDelay;

    ((WDT_T *) (((0x40000000UL) + 0x00040000) + 0x00000))->CTL = u32TimeoutInterval | (0x1ul << (7)) |
               (u32EnableReset << (1)) |
               (u32EnableWakeup << (4));
    return;
}
