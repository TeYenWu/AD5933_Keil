...
# 12 "Library\\StdDriver\\src\\scuart.c"
...
static uint32_t SCUART_GetClock(SC_T *sc)
{
    ...
    if(sc == ((SC_T *) (((0x40000000UL) + 0x00040000) + 0x50000)))
        u32Num = 0;
# 64 "Library\\StdDriver\\src\\scuart.c"
    else
        return 0;

    u32ClkSrc = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL3 >> (2 * u32Num)) & (0x3ul << (0));
...
# 90 "Library\\StdDriver\\src\\scuart.c"
    u32Clk /= (((((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV1 >> (8 * u32Num)) & (0xfful << (0))) + 1);
