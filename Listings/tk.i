...
void TK_Open(void)
{
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CTL |= (0x1ul << (31));
    
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->IDLESEL = 0;
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLSEL = 0;
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLCTL &= ~((0x3ul << (0)) | (0x3ul << (2)));
}
...
void TK_SetScanMode(uint32_t u32Mode)
{
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CTL &= ~(0x1ul << (25));
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->REFCTL &= ~(0x1ul << (23));
    if(u32Mode == ((0x1ul << (25))))
    {
        ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CTL |= u32Mode;
    }
    else if(u32Mode == ((0x1ul << (23))))
    {
        ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->REFCTL |= u32Mode;
    }
...
void TK_ConfigSensitivity(uint32_t u32PulseWidth, uint32_t u32SenseCnt, uint32_t u32AVCCHSel)
{
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->REFCTL = (((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->REFCTL & ~((0x3ul << (28)) | (0x3ul << (24)))) | (u32PulseWidth | u32SenseCnt);
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CTL = (((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CTL & ~(0x7ul << (20))) | u32AVCCHSel;
}
...
void TK_SetCapBankPol(uint32_t u32CapBankPolSel)
{
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLCTL = (((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLCTL & ~(0x3ul << (4))) | u32CapBankPolSel;
}
...
void TK_SetTkPol(uint32_t u32Mask, uint32_t u32PolSel)
{
    ...
    if((1ul << 16) & u32Mask)
        ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLCTL = (((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLCTL & ~(0x3ul << (2))) | (u32PolSel << (2));

    for(i = 0 ; i < 16 ; i++)
    {
        if((1ul << i) & u32Mask)
            ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLSEL = (((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLSEL & ~((0x3ul << (0)) << (i*2))) | (u32PolSel << (i*2));
    }
}
...
void TK_EnableTkPolarity(uint32_t u32Mask)
{
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->POLCTL |= (u32Mask << (8));
}
...
void TK_SetCompCapBankData(uint32_t u32TKNum, uint32_t u32CapData)
{
    *(volatile uint32_t *)(&(((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CCBDAT0) + (u32TKNum >> 2)) &= ~((0xfful << (0)) << (u32TKNum % 4 * 8));
    *(volatile uint32_t *)(&(((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CCBDAT0) + (u32TKNum >> 2)) |= (u32CapData << (u32TKNum % 4 * 8));
}
...
void TK_SetRefKeyCapBankData(uint32_t u32CapData)
{
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CCBDAT4 = (((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->CCBDAT4 & ~(0xfful << (24))) | (u32CapData << (24));
}
...
void TK_SetScanThreshold(uint32_t u32TKNum, uint32_t u32HighLevel, uint32_t u32LowLevel)
{
    *(volatile uint32_t *)(&(((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->TH0_1) + (u32TKNum >> 1)) &= ~(((0xfful << (8)) | (0xfful << (0))) << (u32TKNum % 2 * 16));
    *(volatile uint32_t *)(&(((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->TH0_1) + (u32TKNum >> 1)) |= ((u32HighLevel << (8)) | (u32LowLevel << (0))) << (u32TKNum % 2 * 16);
}
...
void TK_EnableInt(uint32_t u32Msk)
{
    ((TK_T *) (((0x40000000UL) + 0x00040000) + 0xA2000))->INTEN |= u32Msk;
}
