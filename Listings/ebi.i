...
# 12 "Library\\StdDriver\\src\\ebi.c"
...
void EBI_Open(uint32_t u32Bank, uint32_t u32DataWidth, uint32_t u32TimingClass, uint32_t u32BusMode, uint32_t u32CSActiveLevel)
{
    volatile uint32_t *pu32EBICTL  = (uint32_t *)((uint32_t)&((EBI_T *) ((0x40000000UL) + 0x10000))->CTL0 + (u32Bank * 0x10));
    volatile uint32_t *pu32EBITCTL = (uint32_t *)((uint32_t)&((EBI_T *) ((0x40000000UL) + 0x10000))->TCTL0 + (u32Bank * 0x10));
