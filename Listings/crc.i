...
# 12 "Library\\StdDriver\\src\\crc.c"
...
void CRC_Open(uint32_t u32Mode, uint32_t u32Attribute, uint32_t u32Seed, uint32_t u32DataLen)
{
    ((CRC_T *) ((0x40000000UL) + 0x31000))->SEED = u32Seed;
    ((CRC_T *) ((0x40000000UL) + 0x31000))->CTL = u32Mode | u32Attribute | u32DataLen | (0x1ul << (0));

     
    ((CRC_T *) ((0x40000000UL) + 0x31000))->CTL |= (0x1ul << (1));
}
...
uint32_t CRC_GetChecksum(void)
{
    switch(((CRC_T *) ((0x40000000UL) + 0x31000))->CTL & (0x3ul << (30)))
    {
        case 0x00000000UL:
        case 0x80000000UL:
            return (((CRC_T *) ((0x40000000UL) + 0x31000))->CHECKSUM & 0xFFFF);

        case 0xC0000000UL:
            return (((CRC_T *) ((0x40000000UL) + 0x31000))->CHECKSUM);

        case 0x40000000UL:
            return (((CRC_T *) ((0x40000000UL) + 0x31000))->CHECKSUM & 0xFF);
